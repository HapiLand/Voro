...
[CreateAssetMenu(menuName = "Voro/Node/Data/new Angle")]
[Serializable]
public class Angle : NodeDataDefinition {
  ...
  public override void DrawGUI(SerializableDictionary<string, object> properties) {
    ...
    var updated = GUILayout.HorizontalSlider(current, 0, 360, GUILayout.Width(InputWidth));
