...
[CreateAssetMenu(menuName = "Voro/Node/Data/new RampFloat")]
[Serializable]
public class RampFloat : NodeDataDefinition {
  // todo ramp float
  #region Serialized Fields

  [SerializeField] float defaultValue; // (int, float, float)

  #endregion
  void OnEnable() {
    DataType = DataType.RampFloat;
  }
