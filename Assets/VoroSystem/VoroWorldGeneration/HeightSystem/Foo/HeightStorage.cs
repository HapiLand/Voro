...
/// <summary>
/// stores height values in a 10x10 area
/// </summary>
public class HeightStorage {
  readonly float[,] _heightMap;
  readonly int _worldSize;
  public readonly float StepSize;

  /// <summary>
  /// constructor populates the array with height values
  /// </summary>
  /// <param name="worldSize"> number of points along XZ axis </param>
  /// <param name="stepSize"> distance between points, increases resolution </param>
  public HeightStorage(int worldSize, float stepSize) {
  ...
  public (int minX, int minZ, int maxX, int maxZ) GetSampleBounds(Region region) {
  ...
  /// <summary>
  /// returns the underlying height map
  /// </summary>
